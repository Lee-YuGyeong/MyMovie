...
public class Fragment_home_2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("2. " + arrayList.get(1).getTitle());
        textView2.setText("예매율  " + arrayList.get(1).getReservation_rate() + "% | " + arrayList.get(1).getGrade() + "세 관람가 | " + arrayList.get(1).getDateValue() + " 개봉");

        String url = arrayList.get(1).getImage();
