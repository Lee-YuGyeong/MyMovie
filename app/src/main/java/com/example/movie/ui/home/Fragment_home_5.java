...
public class Fragment_home_5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.onFragmentChanged(0,"5");
            }
        });
    ...
    public void processResponse(String response){
        ...
        if(info.code == 200) {
            ...
            String url = movieList.result.get(4).image;

            Glide.with(getActivity()).load(url).into(imageView);

            textView.setText("5. " + movieList.result.get(4).title.toString());
            textView2.setText("예매율  " + movieList.result.get(4).reservation_rate + "% | " + movieList.result.get(4).grade + "세 관람가 | " + movieList.result.get(4).date + " 개봉");
    ...
    public void setDatabaseData(){
        ...
        String url = list.get(4).getImage();
        Glide.with(getActivity()).load(url).into(imageView);
