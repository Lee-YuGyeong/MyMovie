...
public class Fragment_home_5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("5. " + arrayList.get(4).getTitle());
        textView2.setText("예매율  " + arrayList.get(4).getReservation_rate() + "% | " + arrayList.get(4).getGrade() + "세 관람가 | " + arrayList.get(4).getDateValue() + " 개봉");

        String url = arrayList.get(4).getImage();
        Glide.with(getActivity()).load(url).into(imageView);

        id = arrayList.get(4).getId();
