...
import com.example.movie123.ui.home.Fragment_home_1;
import com.example.movie123.ui.home.Fragment_home_2;
...
public class MainActivity extends AppCompatActivity implements  FragmentCallBack {
    ...
    public void onFragmentChanged(int index){
        if (index ==1){
            getSupportFragmentManager().beginTransaction().replace(R.id.container,moiveDetailFragment).addToBackStack(null).commit();
